/* Generated By:JavaCC: Do not edit this line. RbParserTokenManager.java */
...
/** Token Manager. */
public class RbParserTokenManager implements RbParserConstants
{
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               case 0:
                  ...
                  break;
               case 1:
                  if ((0xf400ff7b00000000L & l) != 0L && kind > 5)
                     kind = 5;
                  break;
               case 3:
...
"", null, null, null, "\143\154\141\163\163", null, null, null, null, };
...
/** Constructor. */
public RbParserTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public RbParserTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
